(function(window, $) {
    ...
    //入口函数
    var luo = function(ele) {
        return new luo.prototype.init(ele);
    };

    //简化一下
    luo.fn = luo.prototype;

    //超简单扩展函数
    luo.fn.extend = function(o1, o2) {
        var o2 = o2 || this;
        for (var key in o1) {
            o2[key] = o1[key];
        }
    ...
    luo.fn.animate = function(obj, duration) {
        var ele = this[0];
    ...
    luo.fn.slide = function(obj) {
        ...
        Slide.prototype = {
            ...
            css_init: function() {
                ...
                pic.style = _pic;
                luo.fn.each(pic_li, function(i, value) {
    ...
    //重置原型
    luo.fn.init.prototype = luo.fn;

    //简化符号
    var _luo = window.luo,
        __ = window._;
    luo.noConflict = function(deep) {
        if (window._ === luo) {
            window._ = __;
        }
        if (deep && window.luo === luo) {
            window.luo = _luo;
        }
        return luo;
    }

    window._ = window.luo = luo;
